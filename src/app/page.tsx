...
export default function HomePage() {
  return (
    <MarketingShell>
      ...
      <section className="mx-auto max-w-6xl px-5 pt-14 md:px-8"><div className="flex flex-col gap-5 rounded-2xl border border-blue-200 bg-blue-50 p-7 md:flex-row md:items-center md:justify-between"><div><p className="text-sm font-bold uppercase tracking-[0.18em] text-blue-700">Engineering case study</p><h2 className="mt-2 text-2xl font-black text-[#111c3d]">See the problem, architecture, tradeoffs, and verification boundary.</h2></div><PrimaryLink href="/case-study">Read the case study</PrimaryLink></div></section>
