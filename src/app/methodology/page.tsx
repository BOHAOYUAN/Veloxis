...
export const metadata: Metadata = { title: 'Methodology and limits', description: 'How Veloxis produces reproducible retirement scenario comparisons and where its model stops.', alternates: { canonical: absoluteUrl('/methodology') } };
...
const sections = [
  ...
  ['Plan boundaries', 'Success and ruin probabilities are measured at the household’s entered plan-end age, not at a fixed age. Retirement starts at the entered retirement age. When Proposed retirement is delayed, employment income scheduled to end immediately before Current retirement is extended to the new retirement boundary; other cash-flow dates remain unchanged.'],
